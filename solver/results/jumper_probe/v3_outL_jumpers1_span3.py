# jumper_probe.py on routes_v3.py: OUT L rerouted, jumpers <= 1. NOT a build.
# JUMPER on OUT L-: (44, 3) -> (44, 6) over [(44, 4), (44, 5)]
...
routes = [
 ...
 ('L+ : T1 pin 11 -> OUT (mirrored)', OUT_C, [(20, 5), (21, 5), (21, 0), (44, 0), (44, 2), (45, 2), (45, 3), (47, 3), (47, 8), (46, 8)], False),
 ('L- : T1 pin 7 -> OUT (mirrored)', OUT_C, [(20, 13), (21, 13), (21, 10), (19, 10), (19, 6), (22, 6), (22, 1), (43, 1), (43, 3), (44, 3), (44, 8), (45, 8)], False),
]
